...
This file replaces the misnamed `# data.json` which contained Python code but a .json name.
"""
...
QUESTIONS = [
    {
        ...
        "answer": (
            "EVA automates the process of verifying a patient’s eligibility and "
            "benefits information in real-time, eliminating manual data entry errors "
